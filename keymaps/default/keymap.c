...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_98_KEYS(
        // Row 1: 17 keys
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,              KC_MUTE,  KC_MPLY,  KC_MPRV,  KC_MNXT,   
        // Row 2: 18 keys
        ...
        // Row 6: 12 keys
        KC_LCTL,  MO(FN),   KC_LALT,                      KC_SPC,                                 KC_RALT,  MO(FN),   KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,    KC_P0,    KC_PENT   
    ),

    [FN] = LAYOUT_98_KEYS(
        // Row 1: 17 keys
        RESET,    KC_BRID,  KC_BRIU,  _______,  _______,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,             KC_CALC,  KC_WHOM,  KC_MAIL,  KC_MYCM,  
        // Row 2: 18 keys
        ...
        // Row 6: 12 keys
        _______,  _______,  _______,                      _______,                                _______,  _______,  _______,  _______,  _______,  _______,    KC_PDOT,  KC_PENT
    )
};
